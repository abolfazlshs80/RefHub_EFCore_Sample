...
namespace RefHub_EFCore_Sample.Migrations
{
    ...
    [Migration("20250225183542_Add-Rel-FileToUser")]
    partial class AddRelFileToUser
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FileManagerUser", b =>
                {
                    b.Property<int>("FileManagerFileId")
                        .HasColumnType("int");

                    b.Property<int>("UserId")
                        .HasColumnType("int");

                    b.HasKey("FileManagerFileId", "UserId");

                    b.HasIndex("UserId");

                    b.ToTable("FileManagerUser");
                });
            ...
            modelBuilder.Entity("RefHub_EFCore_Sample.Database.Model.User", b =>
                {
                    ...
                    b.Property<string>("FullName")
                        ...
                        .HasColumnType("nvarchar(max)")
                        .HasComputedColumnSql("[Family]+' '+ [Name]");
            ...
            modelBuilder.Entity("FileManagerUser", b =>
                {
                    b.HasOne("RefHub_EFCore_Sample.Database.Model.FileManager", null)
                        .WithMany()
                        .HasForeignKey("FileManagerFileId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("RefHub_EFCore_Sample.Database.Model.User", null)
                        .WithMany()
